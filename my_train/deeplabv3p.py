...
# 数据集存放目录
DATA_DIR = '/home/zju/data_szw/paddlers/data/inria'
# 训练集`file_list`文件路径
TRAIN_FILE_LIST_PATH = '/home/zju/data_szw/paddlers/data/inria/train.txt'
# 验证集`file_list`文件路径
EVAL_FILE_LIST_PATH = '/home/zju/data_szw/paddlers/data/inria/val.txt'
# 数据集类别信息文件路径
LABEL_LIST_PATH = '/home/zju/data_szw/paddlers/data/inria/labels.txt'
# 实验目录，保存输出的模型权重和结果
EXP_DIR = '/home/zju/data_szw/paddlers/output/deeplabv3p_buliding/'
...
#     'https://paddlers.bj.bcebos.com/datasets/rsseg.zip', path='/home/zju/data_szw/paddlers/data/')
