...
# 训练集`file_list`文件路径
TRAIN_FILE_LIST_PATH = osp.join(DATA_DIR,'train.txt')
# 验证集`file_list`文件路径
EVAL_FILE_LIST_PATH = osp.join(DATA_DIR,'eval.txt')
# 数据集类别信息文件路径
LABEL_LIST_PATH = osp.join(DATA_DIR,'labels.txt')
# 实验目录，保存输出的模型权重和结果
EXP_DIR = '/home/zju/data_szw/paddlers/output/det/yolov3_rsod_aircraft'
